...
os_fatal_error:
	...
	mov si, .msg_inform_1		; Inform of fatal error
	call os_print_string

	mov si, .msg_inform_2		; Inform of fatal error
	call os_print_string

	mov si, .msg_inform_3		; Inform of fatal error
	call os_print_string
	...
	mov si, .msg_inform_4		; Ask User to Press CTRL+ALT+DEL
	call os_print_string

	jmp $				; Halt execution

	
	.msg_inform_1		db 'Kernel Panic!', 13, 10, 0
	.msg_inform_2		db 'CHOS has Crashed because either a padie or an error.', 13, 10, 0
	.msg_inform_3	db 'E-Mail me about this at chos-crash@chelectronics.net', 13, 10, 0
	.msg_inform_4		db 13, 10, 'Press CTRL+ALT+DEL To Reboot', 13, 10, 0
